...
const Disclaimer = () => {
    return (
        <Layout 
            title="Disclaimer & Cookie Policy | Rachel Aronne Yoga" 
            description={``}
        >
            <section style={{
                ...
                <div style={{
                    ...
                    <h1 style={{lineHeight: "3rem"}}>DISCLAIMER AND COOKIE POLICY</h1>
                    <p><em>Last updated December 20th, 2022</em></p>
                    <h2>DISCLAIMER</h2>
                    <h3>WEBSITE DISCLAIMER</h3>
                    <p>
                        The information provided by Rachel Aronne Yoga ("we," "us," or "our") 
                        on https://rachelaronneyoga.com (the "Site") and our mobile application 
                    ...
                    <h2>COOKIE POLICY</h2>
                    <p>
                        This Cookie Policy explains how Rachel Aronne Yoga (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, and &quot;our&quot;) uses 
                        cookies and similar technologies to recognize you when you visit our websites at
                        <Link href="https://rachelaronneyoga.com/">
                            &nbsp;https://rachelaronneyoga.com</Link>, (&quot;Websites&quot;). 
                    ...
                    <p>
                        Cookies set by the website owner (in this case, Rachel Aronne Yoga) 
